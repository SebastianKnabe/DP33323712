...
public class Shop24 
{
   ...
   public Shop24 withCustomers(Object... value)
   {
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof ShopCustomer)
         {
            ...
            if ( ! this.customers.contains(item))
            {
               ...
               ((ShopCustomer)item).setShop24(this);
   ...
   public Shop24 withoutCustomers(Object... value)
   {
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof ShopCustomer)
         {
            if (this.customers.contains(item))
            {
               ...
               ((ShopCustomer)item).setShop24(null);
   ...
   public Shop24 withOrders(Object... value)
   {
      if(value==null) return this;
      for (Object item : value)
      {
   ...
   public Shop24 withoutOrders(Object... value)
   {
   ...
   public Shop24 withProducts(Object... value)
   {
      if(value==null) return this;
      for (Object item : value)
      {
         ...
         else if (item instanceof ShopProduct)
         {
            ...
            if ( ! this.products.contains(item))
            {
               ...
               ((ShopProduct)item).setShop24(this);
   ...
   public Shop24 withoutProducts(Object... value)
   {
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof ShopProduct)
         {
            if (this.products.contains(item))
            {
               ...
               ((ShopProduct)item).setShop24(null);
