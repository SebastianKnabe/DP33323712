...
public class Warehouse51 
{
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof WarehouseOrder)
         {
            ...
            if ( ! this.orders.contains(item))
            {
               ...
               ((WarehouseOrder)item).setWarehouse51(this);
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof WarehouseOrder)
         {
            if (this.orders.contains(item))
            {
               ...
               ((WarehouseOrder)item).setWarehouse51(null);
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof WarehouseProduct)
         {
            ...
            if ( ! this.products.contains(item))
            {
               ...
               ((WarehouseProduct)item).setWarehouse51(this);
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof WarehouseProduct)
         {
            if (this.products.contains(item))
            {
               ...
               ((WarehouseProduct)item).setWarehouse51(null);
   ...
   public Warehouse51 withPlaces(Object... value)
   {
      if(value==null) return this;
      for (Object item : value)
      {
         ...
         else if (item instanceof PalettePlace)
         {
            ...
            if ( ! this.places.contains(item))
            {
               ...
               ((PalettePlace)item).setWarehouse51(this);
   ...
   public Warehouse51 withoutPlaces(Object... value)
   {
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof PalettePlace)
         {
            if (this.places.contains(item))
            {
               ...
               ((PalettePlace)item).setWarehouse51(null);
